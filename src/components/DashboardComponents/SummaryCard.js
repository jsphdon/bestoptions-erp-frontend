const SummaryCard = ({ className, amount, description, percentage, currency }) => {
  return (
    <div className={`rounded-lg shadow-sm flex flex-col py-4 px-7 border-slate-100 border min-w-[260px] min-h-[240px] ${className}`}>
