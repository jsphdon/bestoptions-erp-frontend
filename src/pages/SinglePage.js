...
import Overview from "./MainTabContents/Overview";
import FullProfile from "./MainTabContents/FullProfile";
import Logs from "./MainTabContents/Logs";
import Billings from "./MainTabContents/Billings";
...
export default function SinglePage() {
  ...
  const tabContent = [
    ...
    { title: "Full Profile", content: <FullProfile /> },
    { title: "Logs", content: <Logs /> },
    { title: "Billings", content: <Billings /> }
  ];

  return (
    <div className="container lg:max-w-[1200px] mx-auto flex justify-center items-center my-12 px-8">
